...
describe "#translate" do
  ...
  it "retains capitalization from original word" do
    expect(translate("Hunter Houston")).to eq("Unterhay Oustonhay")
    expect(translate("I want to climb Mount Everest")).to eq("Iay antway otay imbclay Ountmay Erestevay")
  end
